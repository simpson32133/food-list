...
!function () {
    var t = {
        702: function (t, e, n) {
            t.exports = function () {
                ...
                }, r = 0, o = void 0, i = void 0, s = function (t, e) {
                    f[r] = t, f[r + 1] = e, 2 === (r += 2) && (i ? i(m) : _())
                };
                var c = "undefined" != typeof window ? window : void 0, a = c || {},
                ...
                } : l ? (v = 0, g = new l(m), y = document.createTextNode(""), g.observe(y, {characterData: !0}), function () {
                    y.data = v = ++v % 2
                }) : d ? ((p = new MessageChannel).port1.onmessage = m, function () {
                ...
                function A(t, e) {
                    if (t === e) T(t, new TypeError("You cannot resolve a promise with itself")); else if (o = typeof (r = e), null === r || "object" !== o && "function" !== o) C(t, e); else {
                        var n = void 0;
                        try {
                            n = e.then
                        } catch (e) {
                ...
                function j(t) {
                    ...
                    if (0 !== e.length) {
                        for (var r = void 0, o = void 0, i = t._result, s = 0; s < e.length; s += 3) r = e[s], o = e[s + n], r ? $(n, r, o, i) : o(i);
                        t._subscribers.length = 0
                    }
                }

                function $(e, n, r, o) {
                    var i = t(r), s = void 0, c = void 0, a = !0;
                    if (i) {
                        try {
                            s = r(o)
                        } catch (t) {
                ...
                var O = function () {
                    ...
                    return t.prototype._enumerate = function (t) {
                        ...
                        if (r === b) {
                            ...
                            if (o === w && t._state !== x) this._settledAt(t._state, e, t._result); else if ("function" != typeof o) this._remaining--, this._result[e] = t; else if (n === H) {
                                var c = new n(E);
                ...
                return H.prototype.then = w, H.all = function (t) {
                    ...
                    var t = void 0;
                    if (void 0 !== n.g) t = n.g; else if ("undefined" != typeof self) t = self; else try {
    ...
    n.g = function () {
        ...
        n(702).polyfill(), window.addEventListener("DOMContentLoaded", (() => {
            ...
            (function (t, e, n, r) {
                const o = document.querySelectorAll(t), i = document.querySelectorAll(e), s = document.querySelector(n);
            ...
            })(".tabheader__item", ".tabcontent", ".tabheader__items", "tabheader__item_active"), function (n, r, o) {
                const i = document.querySelectorAll(n), s = document.querySelector(r);
                i.forEach((t => {
            ...
            }("[data-modal]", ".modal", n), function (t, e) {
                function n(t) {
                    return t >= 0 && t < 10 ? "0${num}" : t
                }

                !function (t, e) {
                    const r = document.querySelector(t), o = r.querySelector("#days"), i = r.querySelector("#hours"),
                        s = r.querySelector("#minutes"), c = r.querySelector("#seconds"), a = setInterval(l, 1e3);
                ...
                (async t => {
                    ...
                    if (!e.ok) throw new Error(`Coul not fetch ${t}, status: ${e.status}`);
                    return await e.json()
                })("http://localhost:3000/menu").then((e => {
                    e.forEach((({img: e, altimg: n, title: r, descr: o, price: i}) => {
                ...
                })), fetch("http://localhost:3000/menu").then((t => t.json()))
            }("form", n), function ({container: t, slide: e, nextArrow: n, prevArrow: r, totalCounter: o, currentCounter: i, wrapper: s, field: c}) {
                let a = 1, l = 0;
                const u = document.querySelectorAll(e), d = document.querySelector(t), h = document.querySelector(r),
                    f = document.querySelector(n), m = document.querySelector(i), p = document.querySelector(o),
                    v = document.querySelector(s), g = document.querySelector(c), y = window.getComputedStyle(v).width;
                u.length < 10 ? (p.textContent = `0${u.length}`, m.textContent = `0${a}`) : (p.textContent = u.length, m.textContent = a), g.style.width = 100 * u.length + "%", g.style.display = "flex", g.style.transition = "0.5s all", v.style.overflow = "hidden", u.forEach((t => {
                    t.style.width = y
                })), d.style.position = "relative";
                const _ = document.createElement("ol"), w = [];
                ...
                f.addEventListener("click", (() => {
                    l == b(y) * (u.length - 1) ? l = 0 : l += b(y), g.style.transform = `translateX(-${l}px)`, a == u.length ? a = 1 : a++, u.length < 10 ? m.textContent = `0${a}` : m.textContent = a, w.forEach((t => t.style.opacity = ".5")), w[a - 1].style.opacity = "1"
                })), h.addEventListener("click", (() => {
                    0 == l ? l = b(y) * (u.length - 1) : l -= b(y), g.style.transform = `translateX(-${l}px)`, 1 == a ? a = u.length : a--, u.length < 10 ? m.textContent = `0${a}` : m.textContent = a, w.forEach((t => t.style.opacity = ".5")), w[a - 1].style.opacity = "1"
                })), w.forEach((t => {
                    t.addEventListener("click", (t => {
                        const e = t.target.getAttribute("data-slide-to");
                        a = e, l = b(y) * (e - 1), g.style.transform = `translateX(-${l}px)`, u.length < 10 ? m.textContent = `0${a}` : m.textContent = a, w.forEach((t => t.style.opacity = ".5")), w[a - 1].style.opacity = "1"
                    }))
                }))
            }({
